...
<div class="two-column-row <?php echo $decoration_colour; ?>">
    <div class="grid-x">
        <?php if ($image_aligned == 'Right'): ?>
            <div class="large-7 medium-12 small-12 image-right">
                <div class="content-container">
                    <?php echo $content; ?>
                </div>
            </div>
            <div class="large-5 medium-12 small-12 image-right">
                <div class="decorated float-right">
                    <img src="<?php echo $imageURL; ?>" alt="<?php echo $imageALT; ?>"/>
                </div>
            </div>
        <?php else: ?>
            <div class="large-5 medium-12 small-12 image-left">
                <div class="decorated float-left">
                    <img src="<?php echo $imageURL; ?>" alt="<?php echo $imageALT; ?>"/>
                </div>
            </div>
            <div class="large-7 medium-12 small-12 image-left">
                <div class="content-container">
                    <?php echo $content; ?>
                </div>
            </div>
